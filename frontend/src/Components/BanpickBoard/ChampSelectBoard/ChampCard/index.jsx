...
const ChampCard = ({ champData }) => {
  const { isPickedChampion, isBannedChampion, recentVersion, pickBanPhase, currentSelectingTeam } =
  ...
  return (
    ...
    >
      <img
        ...
        alt={champData.id}
        src={`${import.meta.env.VITE_API_BASE_URL}cdn/${recentVersion}/img/champion/${
          champData.id
        }.png`}
      />
